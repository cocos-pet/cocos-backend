...
|:-----------|:----------------------------------------------------------------------------------------------------------------------|:-------------------------------------------------------------------------------------------------------------|
|            | <img src="https://github.com/user-attachments/assets/8a3b91e9-9e89-4266-b592-b5bf7d40613d" width="300"/>              | <img src="https://github.com/user-attachments/assets/676a25b6-beb2-49db-8a3a-2a1892003133" width="300"/>     |
| **담당 API** | <ul><li>회원 관련 API</li> <li>병원 관련 API</li> <li>반려동물 관련 API</li> <li>게시물 관련 API</li> </ul>                              | <ul><li>회원 관련 API</li> <li>병원 관련 API</li> <li>반려동물 관련 API</li> <li>댓글 관련 API</li> </ul>                      |
