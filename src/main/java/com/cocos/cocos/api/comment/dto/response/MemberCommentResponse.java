...
public record MemberCommentResponse(
    ...
    public static MemberCommentResponse of(final Long id, final String content, final Long postId, final String postTitle, final LocalDateTime createdAt) {
        return new MemberCommentResponse(id, content, postId, postTitle, createdAt);
    }
}
